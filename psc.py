...
parser.add_argument('-a','--account',type=float, help='defines the account size')
parser.add_argument('-p','--percentage',type=float,help='percentage of stop loss')
...
if args.percentage:
    if args.account:
        ...
        risk_amount = account * (args.risk/100)
    position_size = risk_amount / (args.percentage/100)
    print("Position Size: %f" %position_size)
